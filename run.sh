...
function miui14() {
	...
	sudo sh -c "cat ${rootPath}/files/config/systemContextsAddMiui14 >> product/config/product_file_contexts"
	sudo sh -c "cat ${rootPath}/files/config/systemConfigAddMiui14 >> product/config/product_fs_config"
	# Magisk
